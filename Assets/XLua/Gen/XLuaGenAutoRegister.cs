...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(GGame.Hybird.Frame), GGameHybirdFrameWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(GGame.Hybird.UISever), GGameHybirdUISeverWrap.__Register);
