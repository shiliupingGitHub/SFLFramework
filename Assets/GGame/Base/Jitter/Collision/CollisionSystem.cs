...
namespace Jitter.Collision
{
    ...
    public delegate void CollisionDetectedHandler(RigidBody body1,RigidBody body2, 
                    JVector point1, JVector point2, JVector normal,Fix64 penetration);
    ...
    public delegate bool PassedNarrowphaseHandler(RigidBody body1,RigidBody body2, 
                    ref JVector point, ref JVector normal,Fix64 penetration);
    ...
    public delegate bool RaycastCallback(RigidBody body,JVector normal, Fix64 fraction);
    ...
    public abstract class CollisionSystem
    {
            ...
            out JVector point1, out JVector point2)
        {
            ...
            Fix64 dot1 = JVector.Dot(ref sA, ref normal);
            Fix64 dot2 = JVector.Dot(ref sB, ref normal);
        ...
        /// </summary>
        public abstract bool Raycast(JVector rayOrigin, JVector rayDirection, RaycastCallback raycast, out RigidBody body, out JVector normal,out Fix64 fraction);
        ...
        /// which start at rayOrigin and end in rayOrigin + rayDirection.
        /// </summary>
        public abstract bool Raycast(RigidBody body, JVector rayOrigin, JVector rayDirection, out JVector normal, out Fix64 fraction);
        ...
        protected void RaiseCollisionDetected(RigidBody body1, RigidBody body2,
                                            ...
                                            ref JVector normal, Fix64 penetration)
        {
