...
namespace Jitter.Collision
{
    ...
    public sealed class XenoCollide
    {
        ...
        private static Fix64 CollideEpsilon = 1e-4f;
        ...
        public static bool Detect(ISupportMappable support1, ISupportMappable support2, ref JMatrix orientation1,
             ...
             out JVector point, out JVector normal, out Fix64 penetration)
        {
            // Used variables
            JVector temp1, temp2;
            JVector v01, v02, v0;
            ...
            Fix64 dist = JVector.Dot(ref normal, ref v0);
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    Fix64 d = JVector.Dot(ref normal, ref v1);
                    ...
                    Fix64 delta = JVector.Dot(ref temp1, ref normal);
                    ...
                    if (delta <= CollideEpsilon || penetration <= 0.0f || phase2 > MaximumIterations)
                    {
                        ...
                        if (hit)
                        {
                            ...
                            Fix64 b0 = JVector.Dot(ref temp1, ref v3);
                            JVector.Cross(ref v3, ref v2, out temp1);
                            Fix64 b1 = JVector.Dot(ref temp1, ref v0);
                            JVector.Cross(ref v0, ref v1, out temp1);
                            Fix64 b2 = JVector.Dot(ref temp1, ref v3);
                            JVector.Cross(ref v2, ref v1, out temp1);
                            Fix64 b3 = JVector.Dot(ref temp1, ref v0);

                            Fix64 sum = b0 + b1 + b2 + b3;
                    ...
                    //Fix64 d1 = JVector.Dot(ref temp1, ref v0);


                    //// Compute the tetrahedron dividing face (v4,v0,v2)
                    //JVector.Cross(ref v4, ref v2, out temp1);
                    //Fix64 d2 = JVector.Dot(ref temp1, ref v0);


                    // Compute the tetrahedron dividing face (v4,v0,v3)
                    JVector.Cross(ref v4, ref v0, out temp1);
                    Fix64 dot = JVector.Dot(ref temp1, ref v1);
