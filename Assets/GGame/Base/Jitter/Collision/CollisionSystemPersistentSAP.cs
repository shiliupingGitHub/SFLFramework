...
namespace Jitter.Collision
{
    ...
    public class CollisionSystemPersistentSAP : CollisionSystem
    {
        ...
        {
            Fix64 val1 = sweepPoint1.Value;
            Fix64 val2 = sweepPoint2.Value;
        ...
        //    {
        //        steps++;
        //        Fix64 distance1 = (axis1[index1].Value - rayOrigin.X) / rayDirection.X;
        //        Fix64 distance2 = (axis2[index2].Value - rayOrigin.Y) / rayDirection.Y;
        //        Fix64 distance3 = (axis3[index3].Value - rayOrigin.Z) / rayDirection.Z;


        //        Fix64 dist1 = Math.Abs(distance1);
        //        Fix64 dist2 = Math.Abs(distance2);
        //        Fix64 dist3 = Math.Abs(distance3);
        ...
        /// </summary>
        #region public override bool Raycast(JVector rayOrigin, JVector rayDirection, out JVector normal,out Fix64 fraction)
        public override bool Raycast(JVector rayOrigin, JVector rayDirection, RaycastCallback raycast, out RigidBody body, out JVector normal, out Fix64 fraction)
        {
            body = null; normal = JVector.Zero; fraction = Fix64.MaxValue;

            JVector tempNormal;Fix64 tempFraction;
            bool result = false;
        ...
        /// which start at rayOrigin and end in rayOrigin + rayDirection.
        /// </summary>
        #region public override bool Raycast(RigidBody body, JVector rayOrigin, JVector rayDirection, out JVector normal, out Fix64 fraction)
        public override bool Raycast(RigidBody body, JVector rayOrigin, JVector rayDirection, out JVector normal, out Fix64 fraction)
        {
            fraction = Fix64.MaxValue; normal = JVector.Zero;
