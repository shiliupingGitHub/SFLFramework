...
namespace Jitter.Collision
{
    ...
    public class Octree
    {
        ...
        public void BuildOctree()
        {
            ...
            rootNodeBox = new JBBox(new JVector(Fix64.PositiveInfinity, Fix64.PositiveInfinity, Fix64.PositiveInfinity),
                                           new JVector(Fix64.NegativeInfinity, Fix64.NegativeInfinity, Fix64.NegativeInfinity));
