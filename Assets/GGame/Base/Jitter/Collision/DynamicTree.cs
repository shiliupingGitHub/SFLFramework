...
namespace Jitter.Collision
{
    ...
    public struct DynamicTreeNode<T>
    {
        ...
        public Fix64 MinorRandomExtension;
    ...
    public class DynamicTree<T>
    {
        ...
        private static Fix64 SettingsAABBMultiplier = 2.0f;

        // Added by 'noone' to prevent highly symmetric cases to
        // update the whole tree at once.
        private Fix64 settingsRndExtension = 0.1f;
        ...
        /// </summary>
        public DynamicTree(Fix64 rndExtension)
        {
        ...
        public int AddProxy(ref JBBox aabb, T userData)
        {
            ...
            _nodes[proxyId].MinorRandomExtension = (Fix64)rnd.NextDouble() * settingsRndExtension;
        ...
        public bool MoveProxy(int proxyId, ref JBBox aabb, JVector displacement)
        {
            ...
            //JVector randomExpansion = new JVector((Fix64)rnd.Next(0, 10) * 0.1f, (Fix64)rnd.Next(0, 10) * 0.1f, (Fix64)rnd.Next(0, 10) * 0.1f);
        ...
        private void InsertLeaf(int leaf)
        {
            ...
            while (_nodes[sibling].IsLeaf() == false)
            {
                ...
                Fix64 siblingArea = _nodes[sibling].AABB.Perimeter;
                JBBox parentAABB = new JBBox();
                //parentAABB.Combine(ref _nodes[sibling].AABB, ref leafAABB);
                JBBox.CreateMerged(ref _nodes[sibling].AABB, ref leafAABB, out _nodes[sibling].AABB);

                Fix64 parentArea = parentAABB.Perimeter;
                Fix64 cost1 = 2.0f * parentArea;

                Fix64 inheritanceCost = 2.0f * (parentArea - siblingArea);
