...
namespace Jitter.Collision.Shapes
{
    ...
    public class TerrainShape : Multishape
    {
        ...
        public TerrainShape(Fix64[,] heights, Fix64 scaleX, Fix64 scaleZ)
        {
        ...
        public override int Prepare(ref JBBox box)
        {
            ...
            {
                minX = (int)Fix64.Floor((Fix64)((box.Min.X - sphericalExpansion) / scaleX));
            ...
            {
                maxX = (int)Fix64.Ceiling((Fix64)((box.Max.X + sphericalExpansion) / scaleX));
            ...
            {
                minZ = (int)Fix64.Floor((Fix64)((box.Min.Z - sphericalExpansion) / scaleZ));
            ...
            {
                maxZ = (int)Fix64.Ceiling((Fix64)((box.Max.Z + sphericalExpansion) / scaleZ));
        ...
        public override void SupportMapping(ref JVector direction, out JVector result)
        {
            ...
            int minIndex = 0;
            Fix64 min = JVector.Dot(ref points[0], ref direction);
            Fix64 dot = JVector.Dot(ref points[1], ref direction);
            if (dot > min)
            {
                min = dot;
                minIndex = 1;
