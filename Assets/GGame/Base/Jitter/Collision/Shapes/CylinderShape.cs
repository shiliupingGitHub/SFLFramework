...
namespace Jitter.Collision.Shapes
{
    ...
    {
        private Fix64 height, radius;

        /// <summary>
        /// Sets the height of the cylinder.
        /// </summary>
        public Fix64 Height { get { return height; } set { height = value; UpdateShape(); } }
        ...
        {
            Fix64 sigma = (Fix64)Fix64.Sqrt((Fix64)(direction.X * direction.X + direction.Z * direction.Z));

            if (sigma > 0.0f)
            {
                result.X = direction.X / sigma * radius;
                result.Y = (Fix64)Fix64.Sign(direction.Y) * height * 0.5f;
