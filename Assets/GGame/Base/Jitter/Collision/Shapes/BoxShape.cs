...
namespace Jitter.Collision.Shapes
{
    ...
    public class BoxShape : Shape
    {
        ...
        public BoxShape(Fix64 length, Fix64 height, Fix64 width)
        {
            this.size.X = length;
            this.size.Y = height;
            this.size.Z = width;
        ...
        {
            result.X = (Fix64)Fix64.Sign(direction.X) * halfSize.X;
            result.Y = (Fix64)Fix64.Sign(direction.Y) * halfSize.Y;
            result.Z = (Fix64)Fix64.Sign(direction.Z) * halfSize.Z;
        }
    }
}
