...
namespace Jitter.Dynamics
{
    ...
    public class RigidBody : IBroadphaseEntity, IDebugDrawable, IEquatable<RigidBody>, IComparable<RigidBody>
    {
        ...
        internal Fix64 inactiveTime = 0.0f;
        ...
        public bool IsActive
        {
            ...
            set
            {
                ...
                else if (isActive && !value)
                {
                    ...
                    inactiveTime = Fix64.PositiveInfinity;
        ...
        public void SetMassProperties(JMatrix inertia, Fix64 mass, bool setAsInverseValues)
        {
        ...
        public void SweptExpandBoundingBox(Fix64 timestep)
        {
        ...
        public virtual void PreStep(Fix64 timestep)
        {
            //
        }

        public virtual void PostStep(Fix64 timestep)
        {
            //
        }
