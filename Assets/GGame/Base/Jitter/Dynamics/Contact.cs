...
namespace Jitter.Dynamics
{
    ...
    public class ContactSettings
    {
        ...
        internal Fix64 maximumBias = 10.0f;
        internal Fix64 bias = 0.25f;
        internal Fix64 minVelocity = 0.001f;
        internal Fix64 allowedPenetration = 0.01f;
        internal Fix64 breakThreshold = 0.01f;
    ...
    public class Contact : IConstraint
    {
        ...
        internal Fix64 accumulatedNormalImpulse = 0.0f;
        internal Fix64 accumulatedTangentImpulse = 0.0f;

        internal Fix64 penetration = 0.0f;
        internal Fix64 initialPen = 0.0f;

        private Fix64 staticFriction, dynamicFriction, restitution;
        private Fix64 friction = 0.0f;

        private Fix64 massNormal = 0.0f, massTangent = 0.0f;
        private Fix64 restitutionBias = 0.0f;
        ...
        Fix64 lostSpeculativeBounce = 0.0f;
        Fix64 speculativeVelocity = 0.0f;
        ...
        private Fix64 lastTimeStep = Fix64.PositiveInfinity;
        ...
        public void PrepareForIteration(Fix64 timestep)
        {
            ...
            if (!treatBody1AsStatic)
            {
                ...
                if (!body1IsMassPoint)
                {
                    ...
                    Fix64 num0 = ((rantra.X * body1.invInertiaWorld.M11) + (rantra.Y * body1.invInertiaWorld.M21)) + (rantra.Z * body1.invInertiaWorld.M31);
                    Fix64 num1 = ((rantra.X * body1.invInertiaWorld.M12) + (rantra.Y * body1.invInertiaWorld.M22)) + (rantra.Z * body1.invInertiaWorld.M32);
                    Fix64 num2 = ((rantra.X * body1.invInertiaWorld.M13) + (rantra.Y * body1.invInertiaWorld.M23)) + (rantra.Z * body1.invInertiaWorld.M33);
            ...
            if (!treatBody2AsStatic)
            {
                ...
                if (!body2IsMassPoint)
                {
                    ...
                    // JVector.Transform(ref rantra, ref body1.invInertiaWorld, out rantra);
                    Fix64 num0 = ((rbntrb.X * body2.invInertiaWorld.M11) + (rbntrb.Y * body2.invInertiaWorld.M21)) + (rbntrb.Z * body2.invInertiaWorld.M31);
                    Fix64 num1 = ((rbntrb.X * body2.invInertiaWorld.M12) + (rbntrb.Y * body2.invInertiaWorld.M22)) + (rbntrb.Z * body2.invInertiaWorld.M32);
                    Fix64 num2 = ((rbntrb.X * body2.invInertiaWorld.M13) + (rbntrb.Y * body2.invInertiaWorld.M23)) + (rbntrb.Z * body2.invInertiaWorld.M33);
            ...
            Fix64 num = dvx * normal.X + dvy * normal.Y + dvz * normal.Z;
            ...
            Fix64 relNormalVel = normal.X * dvx + normal.Y * dvy + normal.Z * dvz; //JVector.Dot(ref normal, ref dv);
...

            {
                ...
                Fix64 relTangentVel = -(tangent.X * dvx + tangent.Y * dvy + tangent.Z * dvz);
            ...
            {
                restitutionBias = Math.Max((float)(-restitution * relNormalVel), (float)restitutionBias);
            }
