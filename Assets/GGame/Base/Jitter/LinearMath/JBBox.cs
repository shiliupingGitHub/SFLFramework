...
namespace Jitter.LinearMath
{
    ...
    public struct JBBox
    {
        ...
        static JBBox()
        {
            LargeBox.Min = new JVector(Fix64.MinValue);
            LargeBox.Max = new JVector(Fix64.MaxValue);
            SmallBox.Min = new JVector(Fix64.MaxValue);
            SmallBox.Max = new JVector(Fix64.MinValue);
        }
        ...
        {
            JVector vector3 = new JVector(Fix64.MaxValue);
            JVector vector2 = new JVector(Fix64.MinValue);
