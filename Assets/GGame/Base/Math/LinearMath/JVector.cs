...
namespace GGame.Math
{
    ...
    public struct JVector
    {
        ...
        private static Fix64 ZeroEpsilonSq = JMath.Epsilon * JMath.Epsilon;
        ...
        public JVector(Fix64 x, Fix64 y, Fix64 z)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        public static Fix64 Dot(JVector vector1, JVector vector2)
        {
        ...
        /// <param name="vector2">The second vector.</param>
        /// <returns>Returns the dot product of both vectors.</returns>
        public static Fix64 Dot(ref JVector vector1, ref JVector vector2)
        {
        ...
        #region public Fix64 LengthSquared()
        ...
        public static void Multiply(ref JVector value1, Fix64 scaleFactor, out JVector result)
        {
        ...
        public static JVector operator *(JVector value1, Fix64 value2)
        {
            JVector result;
