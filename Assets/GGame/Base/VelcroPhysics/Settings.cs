...
namespace VelcroPhysics
{
    ...
    {
        public static GGame.Math.Fix64 MaxFloat = GGame.Math.Fix64.MaxValue;
        public static GGame.Math.Fix64 Epsilon = 1.192092896e-07f;
        public static GGame.Math.Fix64 Pi = 3.14159265359f;
        ...
        /// This is in meters.
        /// </summary>
        public static GGame.Math.Fix64 AABBExtension = 0.1f;
        ...
        /// </summary>
        public static GGame.Math.Fix64 AABBMultiplier = 2.0f;

        /// <summary>
        /// A small length used as a collision and constraint tolerance. Usually it is
        /// chosen to be numerically significant, but visually insignificant.
        /// </summary>
        public static GGame.Math.Fix64 LinearSlop = 0.005f;

        /// <summary>
        /// A small angle used as a collision and constraint tolerance. Usually it is
        /// chosen to be numerically significant, but visually insignificant.
        /// </summary>
        public static GGame.Math.Fix64 AngularSlop = (2.0f / 180.0f * Pi);
        ...
        /// </summary>
        public static GGame.Math.Fix64 PolygonRadius = (2.0f * LinearSlop);
        ...
        /// </summary>
        public static GGame.Math.Fix64 VelocityThreshold = 1.0f;

        /// <summary>
        /// The maximum linear position correction used when solving constraints. This helps to
        /// prevent overshoot.
        /// </summary>
        public static GGame.Math.Fix64 MaxLinearCorrection = 0.2f;

        /// <summary>
        /// The maximum angular position correction used when solving constraints. This helps to
        /// prevent overshoot.
        /// </summary>
        public static GGame.Math.Fix64 MaxAngularCorrection = (8.0f / 180.0f * Pi);
        ...
        /// to overshoot.
        /// </summary>
        public static GGame.Math.Fix64 Baumgarte = 0.2f;

        // Sleep
        /// <summary>
        /// The time that a body must be still before it will go to sleep.
        /// </summary>
        public static GGame.Math.Fix64 TimeToSleep = 0.5f;

        /// <summary>
        /// A body cannot sleep if its linear velocity is above this tolerance.
        /// </summary>
        public static GGame.Math.Fix64 LinearSleepTolerance = 0.01f;

        /// <summary>
        /// A body cannot sleep if its angular velocity is above this tolerance.
        /// </summary>
        public static GGame.Math.Fix64 AngularSleepTolerance = (2.0f / 180.0f * Pi);

        /// <summary>
        /// The maximum linear velocity of a body. This limit is very large and is used
        /// to prevent numerical problems. You shouldn't need to adjust this.
        /// </summary>
        public static GGame.Math.Fix64 MaxTranslation = 2.0f;

        public static GGame.Math.Fix64 MaxTranslationSquared = (MaxTranslation * MaxTranslation);

        /// <summary>
        /// The maximum angular velocity of a body. This limit is very large and is used
        /// to prevent numerical problems. You shouldn't need to adjust this.
        /// </summary>
        public static GGame.Math.Fix64 MaxRotation = (0.5f * Pi);

        public static GGame.Math.Fix64 MaxRotationSquared = (MaxRotation * MaxRotation);
        ...
        /// <returns></returns>
        public static GGame.Math.Fix64 MixFriction(GGame.Math.Fix64 friction1, GGame.Math.Fix64 friction2)
        {
            return GGame.Math.Fix64.Sqrt(friction1 * friction2);
        }
        ...
        /// <returns></returns>
        public static GGame.Math.Fix64 MixRestitution(GGame.Math.Fix64 restitution1, GGame.Math.Fix64 restitution2)
        {
